    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="max-w-5xl mt-20 mx-auto p-8 text-gray-800 space-y-10">
        <header className="text-center">
          ...
          <p className="text-lg text-gray-600">Learn more about the mission and team behind EduVault</p>
        </header>
        ...
        <section className="bg-blue-50 rounded-2xl shadow-md p-6 border border-blue-200 flex flex-col md:flex-row-reverse items-center gap-6">
          <div className="flex-1">
        ...
        <section className="bg-white rounded-2xl shadow-md p-6 flex justify-evenly">
          <div>
            <h2 className="text-2xl font-semibold mb-4">📢 Contact Us</h2>
            <p className="text-gray-700">
                Have questions or feedback? Reach out to us at <a className="text-blue-600 underline" href="mailto:hello@sitename.com">hello@eduvault.com</a>. We’d love to hear from you!
            </p>
          </div>
        </section>
      </div>
